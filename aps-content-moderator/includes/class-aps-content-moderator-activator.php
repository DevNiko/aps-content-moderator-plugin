...
if (!class_exists('APS_Content_Moderator_Activator')) {
	class APS_Content_Moderator_Activator {
		...
		public static function activate() {
            ...
            update_option('aps-content-moderator-cm-settings_category1-value', '0.2');
            update_option('aps-content-moderator-cm-settings_category2-value', '0.2');
            update_option('aps-content-moderator-cm-settings_category3-value', '0.2');
